...
$IPAddress = Read-Host -Prompt "Enter new IP Address"
$newhostname = Read-Host -Prompt "Enter new Hostname"
$networkName = (Get-NetConnectionProfile | Where-Object { $_.IPv4Connectivity -eq "Internet" }).Name


#create Crawler Account
net user Crawler 123 /ADD
net localgroup administrators Crawler /add

#to set static ip address
netsh interface ipv4 set address name=$networkName static $IPAddress 255.255.255.0 20.20.1.254
